...
def entrance(data_enter):
    ...
    with open("./input_with_constr_12.json", "r") as f:
    ...
    idx = copy.deepcopy(cell_id_list[0: 35])
    best_score = my_optimizer_strategy(best_score, cell_state, param, CSI_data_option=7, repeat_ratio=0.9,
                                       wireless_contest_simulator=wireless_contest_simulator, cell_id_list=idx)
    best_score = my_optimizer_strategy(best_score, cell_state, param, CSI_data_option=1, repeat_ratio=0.9,
                                       wireless_contest_simulator=wireless_contest_simulator, cell_id_list=idx)
    best_score = my_optimizer_strategy(best_score, cell_state, param, CSI_data_option=2, repeat_ratio=0.9,
                                       wireless_contest_simulator=wireless_contest_simulator, cell_id_list=idx)
    best_score = my_optimizer_strategy(best_score, cell_state, param, CSI_data_option=3, repeat_ratio=0.9,
                                       wireless_contest_simulator=wireless_contest_simulator, cell_id_list=idx)
    best_score = my_optimizer_strategy(best_score, cell_state, param, CSI_data_option=0, repeat_ratio=0.9,
                                       wireless_contest_simulator=wireless_contest_simulator, cell_id_list=idx)
    best_score = my_optimizer_strategy(best_score, cell_state, param, CSI_data_option=4, repeat_ratio=0.9,
                                       wireless_contest_simulator=wireless_contest_simulator, cell_id_list=idx)
    pass
